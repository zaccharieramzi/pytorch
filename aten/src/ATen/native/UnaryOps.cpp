...
CREATE_UNARY_FLOAT_META_FUNC(special_fresnel_integral_c)
CREATE_UNARY_FLOAT_META_FUNC(special_fresnel_integral_s)
...
CREATE_UNARY_TORCH_IMPL_FUNC(special_fresnel_integral_c_out, special_fresnel_integral_c_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_fresnel_integral_s_out, special_fresnel_integral_s_stub)
...
DEFINE_DISPATCH(special_fresnel_integral_c_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_fresnel_integral_s_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
